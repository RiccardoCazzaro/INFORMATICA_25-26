<head>
    <link rel="stylesheet" href="/esercizioFinaleInformatica/frameworkFile/headerProprietario.css?v=<?php echo time(); ?>">
</head>
...
<nav class="intestazioneProprietario">
    <div class="linkHome">
        <a href="/esercizioFinaleInformatica/home.php">Futsal World</a>
