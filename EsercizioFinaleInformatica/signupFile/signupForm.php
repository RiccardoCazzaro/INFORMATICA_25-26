...
document.addEventListener("DOMContentLoaded", function() {
    const segnaleErr = document.getElementById("erroreEmail");
    if (segnaleErr) {
        setTimeout(() => {
  ...
  <form action="signup.php" method="POST">
   <h2>Registrazione</h2>
   <h3>fai anche te la differenza nel calcio A5</h3>
...
<div class="riga">
 ...
 <label for="provincia">Provincia:</label>
  ...
  <div class="colonna">
    ...
    <input type="text" id="CAP" name="CAP" placeholder="es. 30175" maxlength="5" required>
  </div>
</div>
...
<div class="colonna">
   ...
   <input type="text" id="nazionalità" name="nazionalità" required>
  </div>
</div>
